...
## 更新日志
> v3.1.8 & v2.1.8(mv2)（2026-07-04）  
> Improve:  
> 高版本浏览器（chrome 135+）支持小书签  
> 通过 `chrome.userScripts.execute` 实现  
> 
> 135~137: 扩展页面打开开发者模式  
> 138+: 本扩展详情页 打开 `允许运行用户脚本` 选项  

> v3.1.7 & v2.1.7(mv2)（2026-06-08）  
Bugs：
兼容高版本浏览器  
返回搜索视图时 显示不全（#59）  
Improve: 
优化滚动条记忆逻辑（增加参数： clearScrollPosWhenExitFolder）  
优化tab键操作  
代码优化  

> v3.1.6 & v2.1.6(mv2)（2026-05-31）  
Improve: 
兼容其他书签ID不为2的情况  
搜索打开移动端书签的全路径显示异常  
UI和配色调整  

> v3.1.4 & v2.1.4(mv2)（2025-04-30）  
Improve: 
鼠标中键快速添加书签  
